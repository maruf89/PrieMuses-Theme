...
function transliterate_string($txt) {
...
include_once(get_template_directory() . '/include/profile-functions.php');
include_once(get_template_directory() . '/include/location-functions.php');
include_once(get_template_directory() . '/include/user-functions.php');
include_once(get_template_directory() . '/include/registration.php');
include_once(get_template_directory() . '/include/acf-functions.php');
